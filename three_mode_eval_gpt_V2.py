...
def run_cases(parent_dir, save_dir, r, eval_mode, model_name):
    ...
    for _case_name in os.listdir(parent_dir):
        ...
        if not os.path.isdir(_case_dir):
            continue
        _img_dir = os.path.join(_case_dir, "images")
        paths = []
        if os.path.isdir(_img_dir):
            for f in os.listdir(_img_dir):
                if f.lower().endswith((".jpg", ".jpeg", ".png")):
                    paths.append(os.path.join(_img_dir, f))
...
"""
python3 three_mode_eval_gpt_V2.py 1 --mode multimodal --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt_V2.py 2 --mode multimodal --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt_V2.py 3 --mode multimodal --model gpt-5.2-2025-12-11

--

python3 three_mode_eval_gpt_V2.py 1 --mode text --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt_V2.py 2 --mode text --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt_V2.py 3 --mode text --model gpt-5.2-2025-12-11

--

python3 three_mode_eval_gpt_V2.py 1 --mode ablation --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt_V2.py 2 --mode ablation --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt_V2.py 3 --mode ablation --model gpt-5.2-2025-12-11
