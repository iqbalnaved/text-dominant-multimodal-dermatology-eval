            ...
            for f in os.listdir(img_dir):
                if f.lower().endswith((".jpg", ".jpeg", ".png")):
                    encoded_images.append(
                        encode_image(os.path.join(img_dir, f))
                    )
...
"""
python3 three_mode_eval_gpt.py 1 --mode image --model gpt-5.1-2025-11-13
python3 three_mode_eval_gpt.py 2 --mode image --model gpt-5.1-2025-11-13
python3 three_mode_eval_gpt.py 3 --mode image --model gpt-5.1-2025-11-13


----

python3 three_mode_eval_gpt.py 1 --mode multimodal --model o1-2024-12-17
python3 three_mode_eval_gpt.py 2 --mode multimodal --model o1-2024-12-17
python3 three_mode_eval_gpt.py 3 --mode multimodal --model o1-2024-12-17

python3 three_mode_eval_gpt.py 1 --mode text --model o1-2024-12-17
python3 three_mode_eval_gpt.py 2 --mode text --model o1-2024-12-17
python3 three_mode_eval_gpt.py 3 --mode text --model o1-2024-12-17

python3 three_mode_eval_gpt.py 1 --mode image --model o1-2024-12-17
python3 three_mode_eval_gpt.py 2 --mode image --model o1-2024-12-17
python3 three_mode_eval_gpt.py 3 --mode image --model o1-2024-12-17

---

python3 three_mode_eval_gpt.py 1 --mode multimodal --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt.py 2 --mode multimodal --model gpt-5.2-2025-12-11
python3 three_mode_eval_gpt.py 3 --mode multimodal --model gpt-5.2-2025-12-11
"""